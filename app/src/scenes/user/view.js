          ...
          <React.Fragment>
            ...
            <div className="flex flex-wrap justify-between mt-4	space-x-3">
              <div className="w-full md:w-[260px] ">
                ...
                <select className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px] bg-[#fff]" name="job_title" value={values.job_title} onChange={handleChange}>
                  {jobOptions.map((jobOption) => (
                    <option key={values.job_title} value={values.job_title}>
                      {jobOption.label}
                    </option>
                  ))}
                </select>
              </div>
              <div className="w-full md:w-[260px] "></div>
            </div>
